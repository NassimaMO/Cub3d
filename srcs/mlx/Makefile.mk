...
NAME_L		= libmlx_laptop.a

SRC_COMMON	= mlx_new_window.c mlx_pixel_put.c mlx_loop.c \
...
SRC	= $(SRC_COMMON) mlx_init.c

SRC_L = $(SRC_COMMON) mlx_init_laptop.c

OBJ_DIR = obj
OBJ	= $(addprefix $(OBJ_DIR)/,$(SRC:%.c=%.o))
OBJ_L = $(addprefix $(OBJ_DIR)/,$(SRC_L:%.c=%.o))
CFLAGS	= -O3 -Wno-unused-result -I$(INC)
